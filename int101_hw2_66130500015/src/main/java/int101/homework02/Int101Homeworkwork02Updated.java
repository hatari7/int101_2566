...
public class Int101Homeworkwork02Updated {
    ...
    static void work01() {
      ...
      System.out.println("testPositive(9) returns " + testPositive(9));
      System.out.println("computeIsbn10(123456789) returns " + computelsbn10(965448765));
       /*
   ...
   static void work02() {
    ...
    private static void work03() {
        ...
        System.out.println("Created owner1, owner2, account1, account2 Success");
