...
public class Int101Homework01 {
    ...
    static void work03UseOfUtilityClass() {
      ...
      3.4 Show in this "work03UseOfUtilityClass" method how to use 
         ...
         */
        System.out.println("BMI of weight 61.9 kg and height 1.6 m is " + MyUtill.calculateBMI(61.9, 1.6));
        System.out.println("Average of 1,3 and 9 is" + MyUtill.average(1, 3, 9));
    }
